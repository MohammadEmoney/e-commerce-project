...
<head>
    ...
    <link href="{{ asset('marketshop1/image/favicon.png') }}" rel="icon" />
    <title>مارکت شاپ - قالب HTML فروشگاهی</title>
    <meta name="description" content="Responsive and clean html template design for any kind of ecommerce webshop">
    <!-- CSS Part Start-->
    <link rel="stylesheet" type="text/css" href="{{ asset('marketshop1/js/bootstrap/css/bootstrap.min.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('marketshop1/js/bootstrap/css/bootstrap-rtl.min.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('marketshop1/css/font-awesome/css/font-awesome.min.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('marketshop1/css/stylesheet.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('marketshop1/css/owl.carousel.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('marketshop1/css/owl.transitions.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('marketshop1/css/responsive.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('marketshop1/css/stylesheet-rtl.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('marketshop1/css/responsive-rtl.css') }}" />
...
<div class="wrapper-wide">
                ...
                <div class="row"> <span class="drop-icon visible-sm visible-xs"><i class="fa fa-align-justify"></i></span>
                    <div class="pull-left flip left-top">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('users.index') }}">
                                        <i class="fa fa-warning text-yellow"></i> Admin Area
                                    </a>
                                </li>
                                        ...
                                        <ul>
                                            <li>
                                                <table>
                                                    <tbody>
                                                    <tr>
                                                        <td><img alt="" src="{{ asset('marketshop1/image/banner/cms-block.jpg') }}"></td>
                                                        <td><img alt="" src="{{ asset('marketshop1/image/banner/responsive.jpg') }}"></td>
                                                    </tr>
                                                    <tr>
                        ...
                        <div id="language" class="btn-group">
                            <button class="btn-link dropdown-toggle" data-toggle="dropdown"> <span> <img src="{{ asset('marketshop1/image/flags/gb.png') }}" alt="انگلیسی" title="انگلیسی">انگلیسی <i class="fa fa-caret-down"></i></span></button>
                            <ul class="dropdown-menu">
                                <li>
                                    <button class="btn btn-link btn-block language-select" type="button" name="GB"><img src="{{ asset('marketshop1/image/flags/gb.png') }}" alt="انگلیسی" title="انگلیسی" /> انگلیسی</button>
                                </li>
                                <li>
                                    <button class="btn btn-link btn-block language-select" type="button" name="GB"><img src="{{ asset('marketshop1/image/flags/ar.png') }}" alt="عربی" title="عربی" /> عربی</button>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="container">
                <div class="table-container">
                    ...
                    <div class="col-table-cell col-lg-6 col-md-6 col-sm-12 col-xs-12 inner">
                        <div id="logo"><a href="index.html"><img class="img-responsive" src="{{ asset('marketshop1/image/logo.png') }}" title="MarketShop" alt="MarketShop" /></a></div>
                    </div>
                    <!-- Logo End -->
                    <!-- Mini Cart Start-->
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <table class="table">
                                        <tbody>
                                        <tr>
                                            <td class="text-center"><a href="product.html"><img class="img-thumbnail" title="کفش راحتی مردانه" alt="کفش راحتی مردانه" src="{{ asset('marketshop1/image/product/sony_vaio_1-50x50.jpg') }}"></a></td>
                                        ...
                                        <tr>
                                            <td class="text-center"><a href="product.html"><img class="img-thumbnail" title="تبلت ایسر" alt="تبلت ایسر" src="{{ asset('marketshop1/image/product/samsung_tab_1-50x50.jpg') }}"></a></td>
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu_brands dropdown"><a href="#">برند ها</a>
                            <div class="dropdown-menu">
                                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ asset('marketshop1/image/product/apple_logo-60x60.jpg') }}" title="اپل" alt="اپل" /></a><a href="#">اپل</a></div>
                                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ asset('marketshop1/image/product/canon_logo-60x60.jpg') }}" title="کنون" alt="کنون" /></a><a href="#">کنون</a></div>
                                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"> <a href="#"><img src="{{ asset('marketshop1/image/product/hp_logo-60x60.jpg') }}" title="اچ پی" alt="اچ پی" /></a><a href="#">اچ پی</a></div>
                                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ asset('marketshop1/image/product/htc_logo-60x60.jpg') }}" title="اچ تی سی" alt="اچ تی سی" /></a><a href="#">اچ تی سی</a></div>
                                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ asset('marketshop1/image/product/palm_logo-60x60.jpg') }}" title="پالم" alt="پالم" /></a><a href="#">پالم</a></div>
                                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ asset('marketshop1/image/product/sony_logo-60x60.jpg') }}" title="سونی" alt="سونی" /></a><a href="#">سونی</a> </div>
                                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ asset('marketshop1/image/product/canon_logo-60x60.jpg') }}" title="test" alt="test" /></a><a href="#">test</a> </div>
                                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ asset('marketshop1/image/product/apple_logo-60x60.jpg') }}" title="test 3" alt="test 3" /></a><a href="#">test 3</a></div>
                                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ asset('marketshop1/image/product/canon_logo-60x60.jpg') }}" title="test 5" alt="test 5" /></a><a href="#">test 5</a> </div>
                                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ asset('marketshop1/image/product/canon_logo-60x60.jpg') }}" title="test 6" alt="test 6" /></a><a href="#">test 6</a></div>
                                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ asset('marketshop1/image/product/apple_logo-60x60.jpg') }}" title="test 7" alt="test 7" /></a><a href="#">test 7</a> </div>
                                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ asset('marketshop1/image/product/canon_logo-60x60.jpg') }}" title="test1" alt="test1" /></a><a href="#">test1</a></div>
                                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ asset('marketshop1/image/product/apple_logo-60x60.jpg') }}" title="test2" alt="test2" /></a><a href="#">test2</a></div>
                            </div>
                        </li>
                                ...
                                <ul>
                                    <li>
                                        <table>
                                            <tbody>
                                            <tr>
                                                <td><img alt="" src="{{ asset('martketshop1/image/banner/cms-block.jpg') }}"></td>
                                                <td><img alt="" src="{{ asset('martketshop1/image/banner/responsive.jpg') }}"></td>
                                                <td><img alt="" src="{{ asset('martketshop1/image/banner/cms-block.jpg') }}"></td>
                                            </tr>
                                            <tr>
                                                <td><h4>بلاک های محتوا</h4></td>
        ...
        <div class="fpart-second">
            <div class="container">
                <div id="powered" class="clearfix">
                    ...
                    <div class="social pull-right flip"> <a href="#" target="_blank"> <img data-toggle="tooltip" src="{{ asset('marketshop1/image/socialicons/facebook.png') }}" alt="Facebook" title="Facebook"></a> <a href="#" target="_blank"> <img data-toggle="tooltip" src="image/socialicons/twitter.png" alt="Twitter" title="Twitter"> </a> <a href="#" target="_blank"> <img data-toggle="tooltip" src="image/socialicons/google_plus.png" alt="Google+" title="Google+"> </a> <a href="#" target="_blank"> <img data-toggle="tooltip" src="image/socialicons/pinterest.png" alt="Pinterest" title="Pinterest"> </a> <a href="#" target="_blank"> <img data-toggle="tooltip" src="image/socialicons/rss.png" alt="RSS" title="RSS"> </a> </div>
                </div>
                <div class="bottom-row">
                    ...
                    <div class="payments_types"> <a href="#" target="_blank"> <img data-toggle="tooltip" src="{{ asset('marketshop1/image/payment/payment_paypal.png') }}" alt="paypal" title="PayPal"></a> <a href="#" target="_blank"> <img data-toggle="tooltip" src="{{ asset('marketshop1/image/payment/payment_american.png') }}" alt="american-express" title="American Express"></a> <a href="#" target="_blank"> <img data-toggle="tooltip" src="{{ asset('marketshop1/image/payment/payment_2checkout.png') }}" alt="2checkout" title="2checkout"></a> <a href="#" target="_blank"> <img data-toggle="tooltip" src="{{ asset('marketshop1/image/payment/payment_maestro.png') }}" alt="maestro" title="Maestro"></a> <a href="#" target="_blank"> <img data-toggle="tooltip" src="{{ asset('marketshop1/image/payment/payment_discover.png') }}" alt="discover" title="Discover"></a> <a href="#" target="_blank"> <img data-toggle="tooltip" src="{{ asset('marketshop1/image/payment/payment_mastercard.png') }}" alt="mastercard" title="MasterCard"></a> </div>
                </div>
            </div>
        </div>
    ...
    <div id="custom_side_block" class="custom_side_block_left sort-order-4">
        ...
        <table>
            ...
            <tr>
                <td><img alt="" src="{{ asset('image/banner/cms-block.jpg') }}"></td>
            </tr>
            <tr>
...
<!-- JS Part Start-->
<script type="text/javascript" src="{{ asset('marketshop1/js/jquery-2.1.1.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('marketshop1/js/bootstrap/js/bootstrap.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('marketshop1/js/jquery.easing-1.3.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('marketshop1/js/jquery.dcjqaccordion.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('marketshop1/js/owl.carousel.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('marketshop1/js/custom.js') }}"></script>
<!-- JS Part End-->
</body>
</html>