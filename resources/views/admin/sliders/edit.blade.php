...
@section('content')
    <section class="panel">
        ...
        <div class="panel-body">
            <form class="form-horizontal tasi-form" method="post" enctype="multipart/form-data" action="{{route('sliders.update',['id'=>$slider->id])}}">
                {{csrf_field()}}
                {{method_field('PATCH')}}
                ...
                <div class="form-group">
                    ...
                    <img src="{{ $slider->image }}" alt="" height="200">
                    <div class="col-sm-10">
